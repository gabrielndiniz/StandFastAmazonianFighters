 ...
 */
UCLASS()
class SFAF_API UBaseSpell : public UAttributeSet
{
	GENERATED_BODY()

public:
	// --- Combat Modifiers (Dynamic) ---

	/** Damage multiplier for spells */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Attributes|Combat")
	FGameplayAttributeData SpellDamageMultiplier;
	ATTRIBUTE_ACCESSORS(UBaseSpell, SpellDamageMultiplier);
};
